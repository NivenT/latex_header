...
\newcommand{\SO}{\mrm{SO}}
\newcommand{\PSO}{\mrm{PSO}}
\newcommand{\U}{\mrm{U}}
\newcommand{\SU}{\mrm{SU}}
\newcommand{\PSU}{\mrm{PSU}}
...
\newcommand{\fhom}{\mrm H_{\text{fppf}}}
...
\newcommand{\pullback}[6]{
	\begin{tikzcd}[ampersand replacement=\&]
	{#1}\ar[r]\ar[d]\arrow[dr, phantom, "\ulcorner", very near start]\&{#2}\ar[d, "{#3}" right]\\
	{#4}\ar[r, "{#5}" above]\&{#6}
	\end{tikzcd}
}
\newcommand{\pushout}[6]{
	\begin{tikzcd}[ampersand replacement=\&]
	{#1}\ar[r, "{#2}"]\ar[d, "{#4}" left]\&{#3}\ar[d]\\
	{#5}\ar[r]\&{#6}\ar[ul, phantom, "\lrcorner", very near start]
	\end{tikzcd}
}
