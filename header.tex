\usepackage{setspace} 
\setstretch{1.135} % Use \singlespacing,\onehalfspacing, or \setstretch{blah} to change this
...
\usepackage{upgreek}
\usepackage[pagebackref]{hyperref} % pagebackref automatically add backlinks in bibliography
\hypersetup{colorlinks=true, linkcolor=., citecolor=ForestGreen, urlcolor=blue}
\usepackage[capitalise, nameinlink]{cleveref}
\crefformat{equation}{(#2#1#3)} % No 'Eq.' or 'Equation' before equation references
%\crefformat{exinner}{#1#2}
\usepackage{mdframed}
\usepackage{pgfplots}
\usepackage{manfnt}
%\usepackage{calrsfs}
...
% This way references get colored, but other links do not (e.g. in the list of marginal comments)
\newcommand\linkcolor{BrickRed}
\let\crefinner=\cref
\newcommand\mycref[1]{{\color{\linkcolor}\crefinner{#1}}}
\def\cref{\mycref}
\let\refinner=\ref
\newcommand\myref[1]{{\color{\linkcolor}\refinner{#1}}}
\def\ref{\myref}
...
% Have tikzcd place all notes in \displaystyle
% https://tex.stackexchange.com/questions/446613/can-tikzcd-nodes-be-placed-automatically-in-displaystyle
\tikzcdset{
...
\newcommand{\Matrix}[7]{\begin{pmatrix}{#1}&{#2}&{#3}&{#4}&{#5}\\{#6}&{#7}&\MatrixHelper}
\newcommand{\MatrixHelper}[9]{{#1}&{#2}&{#3}\\{#4}&{#5}&{#6}&{#7}&{#8}\\{#9}&\MatrixHelperii}
\newcommand{\MatrixHelperii}[9]{{#1}&{#2}&{#3}&{#4}\\{#5}&{#6}&{#7}&{#8}&{#9}\end{pmatrix}}
\newcommand{\Wedge}{\bigwedge\nolimits}
\newcommand{\topwedge}{\Wedge^{\mrm{top}}}
\newcommand{\Span}[1]{\opname{span}\b{#1}}
...
\newcommand{\pinv}[2][1]{\inv[#1]{\parens{#2}}}
\newcommand{\sqinv}[2][1]{\inv[#1]{\sq{#2}}}
...
\DeclareMathOperator{\LieAlg}{LieAlg}
...
\newcommand{\crisB}{B_{\t{cris}}}
\newcommand{\dRB}{B_{\t{dR}}}
\newcommand{\crisD}{D_{\t{cris}}}
\newcommand{\dRD}{D_{\t{dR}}}
...
\newcommand{\AV}{\mrm{AV}} % abelian varieties
\newcommand{\Isog}{\mrm{Isog}}
...
\newcommand{\liset}[1]{#1_{\opname{lis-\acute et}}} % lisse-etale
\newcommand{\etH}{\operatorname H_{\text{\'et}}}
\newcommand{\ethom}{\operatorname H_{\text{\'et}}}
\newcommand{\etpi}{\pi^{\text{\'et}}}
\newcommand{\lehomR}{\homR_{\opname{lis-\acute et}}}
\newcommand{\lisethomR}{\lehomR}
\newcommand{\fppf}[1]{#1_{\mathrm{fppf}}} % Note sure if this (and \bfppf) are good inclusions % Update: probably they're not
\newcommand{\bfppf}[1]{#1_{\mrm{Fppf}}}
\newcommand{\fhom}{\operatorname H_{\mathrm{fppf}}}
\newcommand{\fhomR}{\homR_{\mathrm{fppf}}}
\newcommand{\mhom}{\opname H_{\mathrm{mot}}}
\newcommand{\dhom}{\opname H_{\mrm{dR}}}
...
\newcommand\homses[4]{
    \begin{tikzcd}[ampersand replacement=\&]
        0\ar[r]\&{\displaystyle #1}\ar[r, "{#2}"]\ar[r]\&{\displaystyle #3}\ar[r, "{#4}"]\&
        \homsesHELPER
}
\newcommand\homsesHELPER[9]{
        {\displaystyle #1}\ar[r]\& 0\\
        0\ar[r]\&{\displaystyle #5}\ar[r, "{#6}"]\&{\displaystyle #7}\ar[r, "{#8}"]\&{\displaystyle #9}\ar[r]\& 0
        \ar[from=lllu, to=lll, "{#2}"]\ar[from=llu, to=ll, "{#3}"]\ar[from=lu, to=l, "{#4}"]
    \end{tikzcd}
}
\newcommand\topcorner[5]{
    \begin{tikzcd}[ampersand replacement=\&]
        {\displaystyle #1}\ar[r, "{#2}"]\ar[d, "{#4}"']\&{\displaystyle #3}\\
        {\displaystyle #5}
    \end{tikzcd}
}
\newcommand\botcorner[5]{
    \begin{tikzcd}[ampersand replacement=\&]
        \&{\displaystyle#1}\ar[d, "{#2}"]\\
        {\displaystyle#3}\ar[r, "{#4}"']\&{\displaystyle#5}
    \end{tikzcd}
}
\newcommand\conediag[6]{
    \begin{tikzcd}[ampersand replacement=\&]
        \&{\displaystyle#1}\ar[dl, "{#2}"']\ar[dr, "{#3}"]\\
        {\displaystyle#4}\ar[rr, "{#5}"']\&\&{\displaystyle#6}
    \end{tikzcd}
}
\newcommand\midtwosimplex[6]{
    \begin{tikzcd}[ampersand replacement=\&, every arrow/.append style={dash}]
        \&{\displaystyle#1}\ar[dl, "{#2}"']\ar[dr, "{#3}"]\\
        {\displaystyle#4}\ar[rr, "{#5}"']\&\&{\displaystyle#6}
    \end{tikzcd}
}
\newcommand\frontthreesimplex[1]{
    \begin{tikzcd}[every arrow/.append style={dash}, ampersand replacement=\&, row sep = large]
        \&{\displaystyle#1}
        \frontthreesimplexHELPER
}
\newcommand\frontthreesimplexHELPER[9]{
        \ar[ddl, "{#1}"']\ar[d, "{#2}" description]\ar[ddr, "{#3}"]\\
        \&{\displaystyle#4}\ar[dl, "{#5}"]\ar[dr, "{#6}"']\\
        {\displaystyle#7}\ar[rr, "{#8}"']\&\&{\displaystyle#9}
    \end{tikzcd}
}
\newcommand\extensiondiag[6]{
    \begin{tikzcd}[ampersand replacement=\&]
        {\displaystyle#1}\ar[r, "{#2}"]\ar[d, "{#4}"']\&{\displaystyle#3}\\
        {\displaystyle#5}\ar[ur, dashed, "{#6}"']
    \end{tikzcd}
}
...
\newcommand{\p}[1]{\!\left(#1\right)} % I'm not sure if I want this \! there...
...
\newcommand{\sqbracks}[1]{\!\left[#1\right]} % I'm not sure if I want this \! there...
...
\newcommand{\dparens}[1]{\!\left(\!\left(#1\right)\!\right)}
\newcommand\dps\dparens % \dp already defined

%% Arrows
%\newcommand{\xlongleftarrow}[1]{\overset{#1}{\longleftarrow}}   % apparently already defined (in overleaf, use "TeX Live Version" >= 2022)
%\newcommand{\xlongrightarrow}[1]{\overset{#1}{\longrightarrow}}
\newcommand{\mapstoo}{\longmapsto}
\newcommand{\from}{\leftarrow}
\newcommand{\fromm}{\longleftarrow}
\newcommand{\xfromm}{\xlongleftarrow}
...
\newcommand{\xiso}[1]{\xto[#1]\sim}
\newcommand{\xisoo}[1]{\underset{#1}\isoo}
\newcommand{\fiso}{\xfrom\sim}
\newcommand{\xfiso}[1]{\xfrom[#1]\sim}
...
%\newcommand{\squigfrom}{\leftsquigarrow}
\newcommand{\dashto}{\dashrightarrow}
% https://tex.stackexchange.com/questions/136772/dotted-or-dashed-xrightarrow/136777#136777
\makeatletter
...
\makeatother
\newcommand\xdashto\xdashrightarrow
\newcommand\xdashfrom\xdashleftarrow
\newcommand\dashtoo{\xdashto{\phantom\too}} % This is silly and not even the right length (it's slightly too long)
...
\newcommand{\xtofrom}[2][]{\overset{#2}{\underset{#1}\tofrom}}
...
\makeatother
\newcommand{\sqigto}{\rightsquigarrow}
\newcommand{\squigfrom}{\leftsquigarrow}
...
\newcommand\equalscolon\eqqcolon
...
\newcommand{\tforeach}{\,\text{ for each }\,}
\newcommand{\tforall}{\,\text{ for all }\,}
\newcommand{\tforalmostall}{\,\text{ for almost all }\,}
...
\newcommand{\tandso}{\,\text{ and so }\,}
\newcommand{\tformany}{\,\text{ for many }\,}
\newcommand{\tthat}{\,\text{ that }\,}
\newcommand{\tandsothat}{\,\text{ and so that }\,}
...
%% Index Stuff
\newcommand\emphasize[1]{{\color{violet}{\texttt{#1}}}} % Used to just be \textbf
...
%% Formatting (probably get rid of this at some point)
\newcommand{\Section}[1]{\newpage\section{#1}}
\newcommand{\Subsection}[1]{\newpage\subsection{#1}}
\newcommand{\Subusbsection}[1]{\newpage\subsubsection{#1}}

%% Randomness
\pgfmathdeclarerandomlist{thuses}{{Thus}{Therefore}{As such}{As we wished}{By this great fortune}{Alors}{Donc}{Following this thread}{Consequently}{Thusforth}{Rejoice}{This can only mean one thing...}{Ergo}{Voila}}
...
% https://tex.stackexchange.com/questions/279058/check-what-kind-of-document-class-is-used
\makeatletter
\@ifclassloaded{amsart}{% true branch
}{%
    %% hacky MSC and keywords in non-amsart class.
    % https://tex.stackexchange.com/questions/23745/keywords-and-msc-classification-in-latex-article-class?rq=1
    \@ifundefined{subjclass}{
...
\newtheorem{defninner}[thm]{Definition}
\newtheorem{cond}[thm]{Conditions}
\newtheorem{notn}[thm]{Notation}
\newtheorem{anotn}[thm]{Abuse of Notation}
\newtheorem{san}[thm]{Sanity Check}
\newtheorem{recinner}[thm]{Recall}
\newtheorem{set}[thm]{Setup}
\newtheorem{exinner}[thm]{Example}
\newtheorem{reminner}[thm]{Remark}
\newtheorem*{fact}{Fact}
\newtheorem*{exampleinner}{Example}
\newtheorem*{assump}{Assumption}
\newtheorem*{simpassump}{Simplifying Assumption}
\newtheorem*{intuition}{Intuition}
\newtheorem*{princex}{Principal Example}
\newtheorem*{nonexinner}{Non-example}
\newtheorem{warninner}[thm]{Warning}
\newtheorem*{slogan}{Slogan}
\newtheorem*{ansinner}{Answer}
\newtheorem*{resp}{Response}
\newtheorem*{histinner}{History}
\newtheorem*{appl}{Application}
\newtheorem*{imrem}{Important Remark}
\newtheorem*{conf}{Confusion}
\newtheorem*{uconf}{Unimportant Confusion}
\newtheorem*{upshot}{Upshot}
\newtheorem*{conv}{Convention}

\theoremstyle{remark}
\newtheorem{urem}[thm]{Unimportant Remark}
\newtheorem{constructinner}[thm]{Construction}
\newtheorem{obs}[thm]{Observation}
\newtheorem{pic}[thm]{Picture}
\newtheorem{note}{Note}
...
%% cref doesn't automatically deduce plural versions (see section 8.1.3 of https://ctan.math.illinois.edu/macros/latex/contrib/cleveref/cleveref.pdf)
\crefname{thm}{Theorem}{Theorems}
\crefname{prop}{Proposition}{Propositions}
\crefname{lemma}{Lemma}{Lemmas}
\crefname{cor}{Corollary}{Corollaries}
\crefname{prob}{Problem}{Problems}
\crefname{exinner}{Example}{Examples}
\crefname{reminner}{Remark}{Remarks}
\crefname{ansinner}{Answer}{Answers}
\crefname{warninner}{Warning}{Warnings}
\crefname{nonexinner}{Non-example}{Non-examples}
\crefname{recinner}{Recall}{Recall}
\crefname{defninner}{Definition}{Definitions}
\crefname{histinner}{History}{History}
\crefname{constructinner}{Construction}{Constructions}

%% https://tex.stackexchange.com/questions/16453/denoting-the-end-of-example-remark
\newcommand\exsymbol{$\triangle$}
\newcommand\remsymbol{$\circ$}
\newcommand\anssymbol{$\star$}
\newcommand\warnsymbol{$\bullet$}
\newcommand\proofsymbol{$\blacksquare$}
\newcommand\nonexsymbol{$\triangledown$}
\newcommand\recsymbol{$\odot$}
\newcommand\defnsymbol{$\diamond$}
\newcommand\histsymbol{$\ominus$}
\newcommand\constructsymbol{$\octagon$}

\newenvironment{ex}[1][]{\begin{exinner}[#1]\pushQED{\qed}\renewcommand\qedsymbol\exsymbol}{\popQED\end{exinner}}
\newenvironment{example}[1][]{\begin{exampleinner}[#1]\pushQED{\qed}\renewcommand\qedsymbol\exsymbol}{\popQED\end{exampleinner}}
\newenvironment{rem}[1][]{\begin{reminner}[#1]\pushQED{\qed}\renewcommand\qedsymbol\remsymbol}{\popQED\end{reminner}}
\newenvironment{ans}[1][]{\begin{ansinner}[#1]\pushQED{\qed}\renewcommand\qedsymbol\anssymbol}{\popQED\end{ansinner}}
\newenvironment{warn}[1][]{\begin{warninner}[#1]\pushQED{\qed}\renewcommand\qedsymbol\warnsymbol}{\popQED\end{warninner}}
\newenvironment{nonex}[1][]{\begin{nonexinner}[#1]\pushQED{\qed}\renewcommand\qedsymbol\nonexsymbol}{\popQED\end{nonexinner}}
\newenvironment{rec}[1][]{\begin{recinner}[#1]\pushQED{\qed}\renewcommand\qedsymbol\recsymbol}{\popQED\end{recinner}}
\newenvironment{defn}[1][]{\begin{defninner}[#1]\pushQED{\qed}\renewcommand\qedsymbol\defnsymbol}{\popQED\end{defninner}}
\newenvironment{hist}[1][]{\begin{histinner}[#1]\pushQED{\qed}\renewcommand\qedsymbol\histsymbol}{\popQED\end{histinner}}
\newenvironment{construct}[1][]{\begin{constructinner}[#1]\pushQED{\qed}\renewcommand\qedsymbol\constructsymbol}{\popQED\end{constructinner}}


%https://tex.stackexchange.com/questions/291235/modifying-an-existing-environment-but-keeping-the-name
\let\proofinner=\proof
%https://tex.stackexchange.com/questions/49056/optional-arguments-in-def
%\NewDocumentCommand{\myproof}{O{}}{\proofinner[#1]\renewcommand{\qedsymbol}{\proofsymbol}}
\newcommand\myproof[1][Proof]{\proofinner[#1]\renewcommand\qedsymbol\proofsymbol}
\def\proof{\myproof}
