...
\begin{itemize}
    ...
    \begin{itemize}
        \item Add marginal comments with \verb+\thought,\question,\answer,\dolater,\remember+ (by default, I use \verb+\thought+). A list of these is at the end of the document\thought{Test}
    ...
    \begin{rem}[stuff]\label{rem}
        ...
        \begin{proof}[Proof Test]
            ...
            \begin{ans}[Parenthetical]
                begin ans.
                \begin{warn}[I probably didn't need to do this on all of them]\label{warn}
                    begin warn
                    \begin{nonex}
                        begin nonex
                        \begin{defn}
...
\begin{itemize}
    ...
    \item \textbackslash myref: \myref{ex} and \myref{rem} and \myref{warn} and \myref{eqn}.
